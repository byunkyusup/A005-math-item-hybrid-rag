...
실측 결과(전량 912개념 인덱스, bge-m3, 질의 10건):

| 질의셋 | sparse | dense | **hybrid** |
|---|:---:|:---:|:---:|
| A. 키워드 (5건) | 1.00 | 1.00 | **1.00** |
| B. 의역 (5건) | 0.40 | 0.80 | **1.00** |
| **A+B 전체 (10건)** | 0.70 | 0.90 | **1.00** |

*(Hit@5)* 키워드 질의는 셋 다 강하지만, **의역 질의에서 sparse가 0.40으로 무너지는 반면 hybrid는 1.00으로 견고**합니다.
